...
def CreateListingView(request, realtor_id, *args, **kwargs):
    ...
    if request.method == "POST":
        ...
        listing = Listing(user_id=user_id, realtor=realtor.id, title=title,town=town, sqft=sqft, bathrooms=bathrooms, bedrooms=bedrooms, address=address, description=description,\
